...
The comprehensive API guide is available on a publically accessible <a href="https://www.postman.com/descent-module-astronomer-28342281/cbank-secure-file-statement-delivery" target="_blank">Postman Collection</a>. Be sure to choose the **Local Dev** Environment to pre-populate all variables.
